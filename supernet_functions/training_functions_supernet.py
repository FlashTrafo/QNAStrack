...
class TrainerSupernet:
    ...
    def _training_step(self, model, loader, optimizer, epoch, arch_mode=None, info_for_logger=""):
        model = model.train()
        ...
        for step, (X, y) in enumerate(loader):
            ...
            loss, track_loss = self.criterion(outs, y, latency_to_accumulate, self.losses_ce, self.losses_lat, N)  # y = target (label)
            loss.backward()
